...
if __name__ == "__main__":
        ...
        for band in band_names:
            ...
            try:
                ...
                output_path = f"{output_dir}/merged_max_{band}_resampled.tif"
        ...
        for band in band_names:
            start_time = time.time()
            try:
                input_path = f"{output_dir}/merged_max_{band}_resampled.tif"
                output_path = f"{output_dir}/merged_max_{band}_125m_wgs84.tif"
